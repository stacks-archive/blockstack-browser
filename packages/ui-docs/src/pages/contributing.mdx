...
We want contributing to Blockstack UI to be enjoyable, and educational for anyone
and everyone. When contributing to this repository, please first discuss the change you wish
to make via creating an issue here.
...
- Clone your fork to your local machine
  `git clone git@github.com:<yourname>/blockstack-ui.git`
...
```sh
git remote add upstream git@github.com:blockstack/blockstack-ui.git
git checkout master
...
```sh
git clone git@github.com:<yourname>/blockstack-ui-docs.git
git checkout -b feature/my-feature-branch
```
