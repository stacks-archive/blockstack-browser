...
import { SearchActions, SearchReducer } from '../../../../app/js/store/search'
...
describe('Search Store: Async Actions', () => {
  ...
  describe('searchIdentities', () => {
    it('returns search results ', () => {
      ...
      .reply(200, { results: [searchResults.muneeb] }, { 'Content-Type': 'application/json' })
      ...
      return store.dispatch(SearchActions.searchIdentities('muneeb', searchUrl, lookupUrl))
      .then(() => {
        const expectedActions = [{ type: 'UPDATE_RESULTS',
                                   query: 'muneeb',
