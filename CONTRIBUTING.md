...
When contributing to Blockstack's documentation, you should edit the documentation source files in [the `/browser/app/` directory of the `master` branch](https://github.com/blockstack/blockstack-browser/tree/master/app).
