...
import { PairBrowserView, LandingView,
  ...
  EnterEmailView,
  ConnectStorageView, PanelShell } from './components'
import { decrypt, isBackupPhraseValid } from '../utils'
import * as panels from './panels'

const PANELS = {
  EMAIL: panels.Email,
  USERNAME: panels.Username,
  PASSWORD: panels.Password,
  HOORAY: panels.Hooray,
  AUTH: panels.Auth,
  KEY_INFO: panels.KeyInfo,
  UNLOCK_KEY: panels.UnlockKey,
  KEY: panels.Key,
  KEY_CONFIRM: panels.KeyConfirm,
  KEY_COMPLETE: panels.KeyComplete,
  RECOVERY_OPTIONS: panels.RecoveryOptions
}
