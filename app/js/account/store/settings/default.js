...
const DEFAULT_API = {
  ...
  nameLookupUrl: 'http://localhost:16268/v1/names/{name}',
  searchUrl: 'https://api.blockstack.com/v1/search?query={query}',
  registerUrl: 'http://localhost:16268/v1/names',
  bitcoinAddressLookupUrl: 'http://localhost:16268/v1/addresses/bitcoin/{address}',
  addressBalanceUrl: 'http://localhost:16268/v1/wallet/balance',
  ...
  priceUrl: 'http://localhost:16268/v1/prices/names/{name}',
  networkFeeUrl: 'https://bitcoinfees.21.co/api/v1/fees/recommended',
  walletPaymentAddressUrl: 'http://localhost:16268/v1/wallet/payment_address',
  pendingQueuesUrl: 'http://localhost:16268/v1/blockchains/bitcoin/pending',
  coreWalletWithdrawUrl: 'http://localhost:16268/v1/wallet/balance',
  ...
  corePingUrl: 'http://localhost:16268/v1/node/ping',
  hostedDataLocation: DROPBOX,
  coreAPIPassword: 'blockstack_integration_test_api_password',
  logServerPort: '',
  s3ApiKey: '',
  s3ApiSecret: '',
  s3Bucket: '',
