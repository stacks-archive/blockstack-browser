...
class Onboarding extends React.Component {
  ...
  render() {
    ...
    const seedString = 'scatter leaf list famous broccoli injury adjust rigid horse dry balance powder'

    const viewProps = [
      {
        show: VIEWS.INITIAL,
        props: {
          next: () => this.updateView(VIEWS.SEED)
        }
      },
      // {
      //   show: VIEWS.EMAIL,
    ...
    return (
      <App>
        <ShellParent
          ...
          {...componentProps}
          invertOnLast
          disableBackOnView={VIEWS.HOORAY}
